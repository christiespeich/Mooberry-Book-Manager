...
/**
 * MBDB_Book_Link Class
 *
 * @since 3.5 ?
 */
 class MBDB_Book_Link { 
	...
	public function __construct( $link, $list ) {
		...
		$this->id = mbdb_get_array_data( 'id', $link );
		$this->link = mbdb_get_array_data( 'link', $link );
		
		$link_name = mbdb_get_array_data( $this->id, $list );
		$this->name = mbdb_get_array_data( 'name', $link_name );
