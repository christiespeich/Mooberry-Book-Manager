 ...
 */
 class MBDB_Review { 
	...
	public function __construct( $review ) {
		...
		$this->name = mbdb_get_array_data( 'mbdb_reviewer_name', $review );
		$this->url = mbdb_get_array_data( 'mbdb_review_url', $review );
		$this->website = mbdb_get_array_data( 'mbdb_review_website', $review );
		$this->review = mbdb_get_array_data( 'mbdb_review', $review );
